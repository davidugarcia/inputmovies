...
<div class="principal">
   ...
   <form action="guardarinput.php?editar=<?=$entrada_actual['id']?>" method="POST" class="was-validated">
      ...
      <div class=" form-group row">
         ...
         <div class="col-sm-10">
            <textarea class="form-control is-invalid" name="descripcion" id="validationTextarea" placeholder="Descripcion"><?=$entrada_actual['descripcion']?></textarea>
      ...
      <div class="form-group row">
         ...
         <div class="col-sm-10">
            <select name="category" class="custom-select">   
               ...
               ?>
                  <option value="<?=$categoria['id']?>" <?=($categoria['id'] == $entrada_actual['categoriaid']) ? 'selected="selected"' : '' ?>>
                     <?=$categoria['nombre']?>
                  </option>
               <?php
                  endwhile;

...
<div class="principal">
   ...
   <form action="actualizardatos.php" method="POST">
      <div class="form-group row">
         ...
         <div class="col-sm-10">
            <input type="text" name="name" value= "<?= $_SESSION['usuario']['nombre'] ?> " class="form-control" placeholder="Nombre">
      ...
      <div class="form-group row">
         ...
         <div class="col-sm-10">
            <input type="text" name="lname" value= "<?= $_SESSION['usuario']['apellido'] ?>" class="form-control" placeholder="Apellido">
      ...
      <div class="form-group row">
         ...
         <div class="col-sm-10">
            <input type="text" id="Email" name="email" value= "<?= $_SESSION['usuario']['email'] ?>" class="form-control" placeholder="email@example.com">
